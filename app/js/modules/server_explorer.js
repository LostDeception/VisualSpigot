              ...
              sortedFiles.forEach((file) => {
                ...
                if (fileInfo) {
                  ...
                  if (!this.excludedFiles.includes(fileName)) {
                    ...
                    var btnIcon =
                      '<i class="fa fa-folder" style="color:var(--folder-color)"></i> ';
                    ...
                    if (!fileInfo.isDirectory()) {
                      ...
                      switch (fileExt) {
                        case ".bat":
                          btnIcon = '<i class="fas fa-file-alt" style="color:var(--file-color)"></i> ';
                          break;
                        case ".txt":
                          btnIcon = '<i class="fas fa-file-alt" style="color:var(--file-color)"></i> ';
                          break;
                        case ".properties":
                          btnIcon =
                            '<i class="fas fa-cogs" style="color:var(--prop-color)"></i> ';
                          break;
                        case ".jar":
                          btnIcon =
                            '<i class="fab fa-java" style="color:var(--jar-color)"></i> ';
                          break;
                        default:
                          btnIcon = '<i class="fa fa-file" style="color:var(--file-color)"></i> ';
                          break;
                      }
                    }
